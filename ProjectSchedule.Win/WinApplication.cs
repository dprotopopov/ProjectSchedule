...
namespace ProjectSchedule.Win
{
    ...
    public partial class ProjectScheduleWindowsFormsApplication : WinApplication
    { // http://documentation.devexpress.com/#Xaf/DevExpressExpressAppWinWinApplicationMembersTopicAll
        public ProjectScheduleWindowsFormsApplication()
        {
            InitializeComponent();
        ...
        private void ProjectScheduleWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e)
        {
        ...
        private void ProjectScheduleWindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
